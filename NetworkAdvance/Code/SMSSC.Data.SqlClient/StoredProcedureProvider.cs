...
namespace SMSSC.Data.SqlClient
{
	...
	public sealed class StoredProcedureProvider
	{
		...
		{
			string nameSpace = "SMSSC.Data.SqlClient"; //System.Reflection.Assembly.GetExecutingAssembly().GetName().Name;
		...
		public static DbCommand GetCommandWrapper(Database database, string commandName, bool useStoredProcedure)
		{
			...
			{
                DbCommand command = database.GetSqlStringCommand(StoredProcedureProvider.GetProcedureBodyFromEmbeddedResource(commandName));
                command.CommandTimeout = DataRepository.Provider.DefaultCommandTimeout;
                return command; 
            }
		}
