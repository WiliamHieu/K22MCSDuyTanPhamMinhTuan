...
namespace SMSSC.Entities
{
    ...
    public static class EntityCache
    {
        ...
        private static string cacheManagerKey = "SMSSC.Entities.EntityCache";
		...
		private static CacheManagerSettings GenerateDefaultCacheManagerSettings()
        {
            ...
            settings.CacheManagers.Add(new CacheManagerData(cacheManagerKey,10000,1000,100,"inMemoryWithEncryptor"));
            return settings;
        }
		#endregion 
