...
namespace SMSSC.Data.Bases
{
	...
	[Serializable]
	[CLSCompliant(true)]
	public abstract partial class EntityProviderBase<Entity, EntityKey> : EntityProviderBaseCore<Entity, EntityKey> where Entity : IEntityId<EntityKey>, new() where EntityKey : IEntityKey, new()
	{
