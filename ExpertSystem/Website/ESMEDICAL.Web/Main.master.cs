...
public partial class Main : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            sbMenu.Append("<li><a href=\"/diabetes\">Quản trị</a></li>");
            sbMenu.Append("<li><a href=\"/about\">Giới thiệu</a></li>");
            lblMainMenu.Text = sbMenu.ToString();

            if (Page.User.Identity.IsAuthenticated)
            {
                string fullName = Common.Web_UserInfo("Fullname");
                ...
                sbDesktopUser.AppendFormat("<li><a class=\"user-info-link\" href=\"/doi-mat-khau\"><i class=\"fa fa-user-circle-o fa-fw\"></i> {0}</a></li>", fullName);
                sbDesktopUser.Append("<li><a class=\"user-info-link\" href=\"/thoat\"><i class=\"fa fa-sign-out fa-fw\"></i> Đăng xuất</a></li>");
                ...
                sbUserMobile.AppendFormat("<li><a class=\"user-info-link\" href=\"/doi-mat-khau\"><i class=\"fa fa-user-circle-o fa-fw\"></i> {0}</a></li>", fullName);
                sbUserMobile.Append("<li><a class=\"user-info-link\" href=\"/thoat\"><i class=\"fa fa-sign-out fa-fw\"></i> Đăng xuất</a></li>");
