<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="DiabetesAdd.aspx.cs" Inherits="DiabetesAdd" %>
<%@ Register Src="~/control/Breakcum.ascx" TagPrefix="uc1" TagName="Breakcum" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainPlaceHolder" Runat="Server">
         <uc1:Breakcum ID="ucBreakcum" runat="server" Left="Cập nhật Thông tin|/diabetes" Right="/diabetes" />
         <asp:HiddenField ID="hDiabetesId" runat="server" ClientIDMode="Static" Value="0"/>
         <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtAge" runat="server" ClientIDMode="Static" CssClass="form-control input-sm number" placeholder="Tuổi ..." maxlength="2" ></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="dvClass">Phân lớp (Class)</label>
                                <div id="dvClass" class="form-control input-sm">
                                    <asp:RadioButtonList ID="rblClass" runat="server" ClientIDMode="Static" RepeatDirection="Horizontal">
                                        <asp:ListItem Selected="True" Value="Negative">Âm tính</asp:ListItem>
                                        <asp:ListItem Value="Positive">Dương tính</asp:ListItem>
                                    </asp:RadioButtonList>
                                </div>
                                <div class="form-item-desc">Thuộc tính xác định có bị bệnh hay không</div>
                            </div>
                        </div>
                        <div class="col-md-12">
            ...
            <script type="text/javascript" src="/js/DiabetesAdd.js"></script>
        </div>  
</asp:Content>
