                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                <label for="cboGender">Giới tính</label>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                <label for="cboAge">Khoảng tuổi</label>
                                <select id="cboAge" class="form-control input-sm">
                                    <option value="" selected="selected">Khoảng tuổi</option>
